                        ...
                        @foreach($bazaars as $bazaar)
                            <div class="recommend-tour-item style2">
                                <div class="recommend-tour-bg bg-f"
                                     style="background-image: url('{{ asset('storage/' . $bazaar->image_1) }}');"></div>
                                <div class="recommend-tour-info">
                                    <h4>
                                        <a href="{{ route('bazaars_details', $bazaar) }}">{{ $bazaar->{'title_' . $locale} }}</a>
                                    </h4>
                                    <p>
                                        <a href="{{ route('bazaars_details', $bazaar) }}">{!! \Illuminate\Support\Str::words($bazaar->{'text_' . $locale}, 10) !!}</a>
                                    </p>
                                    <a class="link" href="{{ route('bazaars_details', $bazaar) }}">
                                        @lang('main.more')
