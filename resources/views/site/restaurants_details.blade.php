...
@section('meta')
    <title>Tourist-attractions.uz - {{ $restaurant->{'title_' . $locale} }}</title>
    ...
    <meta property="og:title" content="Tourist-attractions.uz - {{ $restaurant->{'title_' . $locale} }}"/>
            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-10 offset-md-1">
                    <div class="breadcrumb-title">
                        <h2>{{ $restaurant->{'title_' . $locale} }}</h2>
                        <ul class="breadcrumb-menu">
                            <li><a href="{{ route('home') }}">@lang('main.main') </a>
                                <i class="las la-angle-double-right"></i>
                            </li>
                            <li>@lang('main.restaurants')</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-12 col-12">
                    <div class="tour-details-info">
                        <div class="single-img">
                            <img src="{{ asset('storage/' . $restaurant->image_2) }}"/>
                        </div>
                        <p>{!! $restaurant->{'text_' . $locale} !!}</p>

                        @if($restaurant->location)
                            {!!  $restaurant->location  !!}
                        @elseif($restaurant->lng || $restaurant->ltd)
                                ...
                                var placemarks = [
                                    {
                                        ...
                                        {{--hintContent: '{{$restaurant->{'address_' . $locale} }}',--}}
                                        {{--balloonContent: '{{$restaurant->phone }}',--}}
                                    },
                                ];
