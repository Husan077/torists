                ...
                <div class="col-xl-8 col-lg-8 col-md-12 col-12">
                    <div class="tour-details-info">
                        <div class="single-img">
                            <img src="{{ asset('storage/' . $hotel->image_2) }}"/>
                        </div>
                        <p>{!! $hotel->{'text_' . $locale} !!}</p>

                        @if($hotel->location)
                            {!!  $hotel->location  !!}
                        @elseif($hotel->lng || $hotel->ltd)
                                ...
                                var placemarks = [
                                    {
                                        latitude: {{$hotel->ltd}},
                                        longitude: {{$hotel->lng}},
                                        {{--hintContent: '{{$hotel->{'address_' . $locale} }}',--}}
                                        {{--balloonContent: '{{$hotel->phone }}',--}}
                                    },
                                ];
