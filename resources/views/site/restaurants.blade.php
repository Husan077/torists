                        ...
                        @foreach($restaurants as $restaurant)
                            <div class="recommend-tour-item style2">
                                <div class="recommend-tour-bg bg-f"
                                     style="background-image: url('{{ asset('storage/' . $restaurant->image_1) }}');"></div>
                                <div class="recommend-tour-info">
                                    <h4>
                                        <a href="{{ route('restaurants_details', $restaurant) }}">{{ $restaurant->{'title_' . $locale} }}</a>
                                    </h4>
                                    <p>
                                        <a href="{{ route('restaurants_details', $restaurant) }}">{!! \Illuminate\Support\Str::words($restaurant->{'text_' . $locale}, 10) !!}</a>
                                    </p>
                                    <a class="link" href="{{ route('restaurants_details', $restaurant) }}">
                                        @lang('main.more')
