...
@section('title')
    Добавить новый достопримечательность
@endsection

@section('main')
    <div class="main-content">
        <div class="breadcrumb">
            <h1 class="mr-2">Добавить новый достопримечательность</h1>
            <ul>
                <li><a href="{{ route('attractions.index') }}">Все достопримечательности</a></li>
            </ul>
        </div>
                        ...
                        <form action="{{ route('attractions.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-12 form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('text_uz') is-invalid @enderror"
                                              value="{{ old('text_uz') }}" name="text_uz"></textarea>
                                    <script>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-12 form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('text_ru') is-invalid @enderror"
                                              value="{{ old('text_ru') }}" name="text_ru"></textarea>
                                    <script>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-12 form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('text_en') is-invalid @enderror"
                                              value="{{ old('text_en') }}" name="text_en"></textarea>
                                    <script>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12 form-group mt-3"><h4>Яндекс карта <span
                                            style="font-size: 13px"> (если есть Google карта, то Яндекс карта не надо!!!)</span>
                                    </h4></div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12 form-group mt-3"><h4>Google карта <span
                                            style="font-size: 13px"> (если есть Яндекс карта, то Google карта не надо!!!)</span>
                                    </h4></div>


                                <div class="col-xl-12 col-lg-12 col-md-12 col-12 form-group mb-3">
                                    <textarea value="{{ old('location') }}"
                                              class="form-control @error('location') is-invalid @enderror"
                                              name="location" cols="30" rows="10"></textarea>
                                    @error('location')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
